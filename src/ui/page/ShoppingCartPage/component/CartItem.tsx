        ...
        <>
            <Row className="mb-4 d-flex justify-content-between align-items-center">
                ...
                <Col md="3" lg="3" xl="3" className="d-flex align-items-center">
                    <QuantitySelector quantity={cartItem.cart_quantity} handleMinus={handleMinus} handlePlus={handlePlus}/>
                </Col>
                <Col md="3" lg="2" xl="2" className="text-end">
                    <h6 className="mb-0">${(cartItem.price*cartItem.cart_quantity)}</h6>
                </Col>
